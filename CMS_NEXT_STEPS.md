...
1. Geef de Vercel GitHub App toegang tot de private repo `Pimmetjeoss/goodness-for-all`.
...
2. Test Sveltia met het echte klantaccount.
...
3. Formulieren zijn nog stubbed.
